...
if __name__ == '__main__':
    ...
    data_dir = 'Nvidia'
    sequences = ['Jumping', 'Skating', 'Truck', 'Umbrella', 'Balloon1', 'Balloon2', 'Playground']
    methods = ['NeRF', 'NeRF_t', 'DNeRF', 'NR', 'NSFF', 'DynamicNeRF', 'HyperNeRF', 'TiNeuVox', 'Ours', 'Ours_wo_COLMAP']
